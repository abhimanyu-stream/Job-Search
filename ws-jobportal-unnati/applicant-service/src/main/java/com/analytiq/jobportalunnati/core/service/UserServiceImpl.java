...
import com.analytiq.jobportalunnati.core.dao.RoleRepository;
...
public class UserServiceImpl implements UserService {
	...
	public ResponseEntity<JwtResponse>  login(LoginRequest loginRequest) {// LoginRequest contains username and password 
		...
		try {
			...
			userDetails = customUserDetailsService.loadUserByUsername(loginRequest.getUsername());// 1 approach
			//userDetails = customUserDetailsService.loadUserByUsername(loginRequest.getUsername(), loginRequest.getPassword());
